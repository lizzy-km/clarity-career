                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center gap-2">
                        {job.isSalaryNegotiable ? (
                            <div className="flex items-center gap-2 text-sm muted-foreground"><DollarSign className="h-4 w-4 text-sm muted-foreground" /> <span>Negotiable Salary</span></div>
                        ) : (
                            <div className="flex items-center gap-2 text-sm muted-foreground"><DollarSign className="h-4 w-4 text-sm muted-foreground" /> <span>{`MMK${(job.salaryMin! / 1000)}k - MMK${(job.salaryMax! / 1000)}k`}</span></div>
                        )}                {user && (
